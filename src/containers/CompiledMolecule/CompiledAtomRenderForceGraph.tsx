...
const _CompiledAtomRenderForceGraph: React.FC = ({width, height, elementsInChart}: any) => {
...
export const CompiledAtomRenderForceGraph = connect(mapStateToProps, {})(_CompiledAtomRenderForceGraph);
